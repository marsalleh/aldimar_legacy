...
if (isset($_POST['update_profile'])) {
  ...
  if ($stmt->execute()) {
    ...
    $_SESSION['username'] = $newUsername;
    header("Location: admin_notification.php?profile_updated=1");
    exit();
  } else {
    header("Location: admin_notification.php?error=update_failed");
  }
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Standardized delete button (formerly btn-delete) */
    .btn-delete {
      border: none;
      padding: 6px 12px;
      border-radius: 6px;
