...
while ($row = $resSales->fetch_assoc()) {
  $row['timestamp'] = strtotime($row['time']); // Time is 00:00:00
  $activities[] = $row;
}
...
<head>
  ...
  <style>
    * {
    ...
    /* Sidebar */
    /* Sidebar styles moved to css/admin_sidebar.css */
    ...
    /* User Sidebar (Right) */
    /* User Sidebar and Overlay styles moved to css/admin_sidebar.css */
  ...
  <div class="container">
    ...
    <div class="main-content" id="mainContent">
      <header>
        ...
        <div class="user-info">
          <a href="admin_notification.php" class="notif-wrapper" title="Notifications">
